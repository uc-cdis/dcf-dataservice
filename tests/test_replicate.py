...
def test_resumable_streaming_copy_called(mock_bucket_exists, mock_check_blob,  mock_client):
...
@patch('scripts.google_replicate.check_blob_name_exists_and_match_md5')
@patch('scripts.google_replicate.bucket_exists')
def test_resumable_streaming_copy_not_called_due_to_existed_blob(mock_bucket_exists, mock_check_blob,  mock_client):
    mock_bucket_exists.return_value = True
...
@patch('scripts.google_replicate.bucket_exists')
def test_resumable_streaming_copy_not_called_due_to_not_existed_bucket(mock_bucket_exists):
...
@patch('scripts.google_replicate.check_blob_name_exists_and_match_md5')
@patch('scripts.google_replicate.bucket_exists')
def test_resumable_streaming_copy_called_one_time(mock_bucket_exists, mock_check_blob,  mock_client):
    mock_bucket_exists.return_value = True
...
@patch('scripts.google_replicate.check_blob_name_exists_and_match_md5')
@patch('scripts.google_replicate.bucket_exists')
def test_resumable_streaming_copy_called_two_time(mock_bucket_exists, mock_check_blob,  mock_client):
    mock_bucket_exists.return_value = True
...
def test_streamUpload_called(mock_requests_get, mock_client):
    ...
    resumable_streaming_copy({"fileid":"test_file_id","filename":"test file name"},mock_client, 'bucket_test', 'blob_test', {})
